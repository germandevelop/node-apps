...
typedef void(*tracking_session_state_set_t)(int32_t tracking_session_id, bool is_needed_to_start);
typedef void(*tracking_summary_process_t)(tracking_summary_t const * const tracking_summary);
typedef void(*tracking_failure_catch_t)(tracking_partner_error_t error_code);
